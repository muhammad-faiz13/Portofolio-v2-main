<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Muhammad faiz</h1>
      <div class="py-2">
        <h1
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="400" height="400" decoding="async" data-nimg="1"
        class="w-10/11 md:h-auto rounded-full border-4 border-amber-200 pict" src="/img/portfolio-fotofaiz.jpg">
    </div>
  </main>
</template>
