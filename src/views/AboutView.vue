    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 6,
          name: 'Codeigniter',
          imageUrl: 'https://icon.icepanel.io/Technology/svg/CodeIgniter.svg',
          status: 'Intermediate'
        },
        {
          id: 7,
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src=/img/portfolio-fotofaiz.jpg alt="fotofaiz">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Muhammad faiz. I'm a web developer from Cirebon, West Java. I
